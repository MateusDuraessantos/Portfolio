export const images =
{
  carrossel_01: [
      ...
      paths: [
        {
          ...
          alt: 'Mapalytics consulting platform'
        },
      ],
      thumb: {
        img: 'mapalytics/thumb-mapalytics.jpg',
        alt: 'Mapalytics website',
      },
      ano: 'March, 2024',
    ...
    {
      id: 'mp2rewfwbiuz',
      name: 'Tre Communication',
      link: 'https://tre-art-4b66f.web.app/',
      paths: [
        {
          img: 'tre/mobile-tre-studio-design.jpg',
          alt: 'Mobile mockup version of Tre Studio website'
        },
        {
          img: 'tre/studio-tre.jpg',
          alt: 'Desktop mockup version of Tre Studio website'
        },
        {
          img: 'tre/website-tre-studio-design.jpg',
          alt: 'Desktop version of Tre Studio website'
        },
      ],
      thumb: {
        img: 'tre/thumb-website-tre-studio-design.jpg',
        alt: 'One-page Tre Designs website | Vue.js HTML CSS'
      },
      ...
      description: `
        ...
        <br>
        <p>
          <strong>Design</strong>: All of Tre's branding was analyzed and, following the brief, I created a new UX/UI landing page interface. The project was built following design thinking methodologies and prototyped in Figma.
        </p>
        
        <p>
          <strong>Development</strong>: I developed the entire front-end structure, used GitHub to manage and version the code, and finally hosted it on Tre's domain to go live.
        </p>
        <br>
        <b>Development kit</b>
        <br>
    ...
    // TCC
    {
      ...
      paths: [
        {
          ...
          alt: 'My final project mockup'
        },
        {
          img: 'tcc/pagina_inicial_do_projeto.jpg',
          alt: 'My final project website'
        },
        {
          img: 'tcc/arvore_de_navegacao_proposta.jpg',
          alt: 'Navigation structure of the website developed in the final project'
        },
      ],
      ano: 'September, 2022',
      thumb: {
        img: 'tcc/thumb-pagina_inicial_do_projeto.jpg',
        alt: 'Final project website - Mackenzie'
      },
      ...
      description: `
        ...
        <br>
        <b>My role</b>
        <p><strong>Design process:</strong> Two main methodologies were used to guide the project: <strong>HCD (Human Centered Design)</strong> and <strong>Jesse James Garrett's 5 elements of UX design</strong>, addressing strategy, scope, structure, skeleton, and surface.</p>
    ...
    {
      id: 'usususuuss',
      name: 'Mapalytics - Distance Calculator',
      paths: [
        {
      ...
      description: `
        <b>Project portfolio</b>
        <br>
        <p>The Distance Calculator is a tool from a Mapalytics product, by the startup <a href="https://datamachina.com.br/" target="_blank">Data Machina</a>, focused on helping companies analyze their own territorial reach. The tool can receive multiple inputs of origins and destinations of different types and calculate the distances between the selected points all at once.</p>
        <p>Another major feature is the possibility of searching for new leads around your origin point using a customizable radius. It provides insights into which options are better and which are too far away, based on the distance between points.</p>
        ...
        <p>
          ...
          <br>
          <strong>Design</strong> - In addition to development, I actively contributed to the interface design and user experience. I applied Jesse James Garrett’s “Five Elements of User Experience” methodology to create a clear and efficient interface.
        </p>
      `,
    },
    /* Design System */
    {
      id: '07665849',
      name: 'Design System | Data Machina',
      link: 'https://design-system-dm.web.app',
      paths: [
        {
          img: 'design_system/design_system.png',
          alt: 'Design System Data Machina preview'
        },
        {
          img: 'design_system/website_design_system.png',
          alt: 'Design System Data Machina preview'
        },
        {
          img: 'design_system/design_system_mobile_instagram.jpg',
          alt: 'Design System Data Machina preview'
        },
      ],
      thumb: {
        img: 'design_system/thumb.png',
      ...
      description: `
        ...
        <br>
        <p>
          I was responsible for the entire frontend development of the project. The website was built with Vue.js 2 and Element Plus, hosted through Firebase Hosting. My main goal was to customize and extend all Element Plus components to align them with Data Machina’s visual identity and design principles, ensuring a cohesive and branded user experience across all interfaces.
        </p>
        <br>
        <b>Development kit</b>
        <br>
        <p>Vue.js 2, JavaScript, HTML, CSS, Firebase Hosting, Element Plus and GitHub.</p>
      `,
    },
    // Teclakey
    {
      ...
      paths: [
        {
          ...
          alt: 'Mobile mockup of the TeclaKey website'
        },
        {
          img: 'teclakey/teclakey-webiste-de-design.jpg',
          alt: 'Desktop version of the TeclaKey website'
        },
        {
          img: 'teclakey/teclakey.gif',
          alt: 'Website animation mockup'
        },
      ],
      ano: 'May, 2022',
      thumb: {
        img: 'teclakey/thumb-teclakey-webiste-de-design.jpg',
        alt: 'TeclaKey website - UX/UI - Firebase',
      },
      ...
      description: `
        ...
        <br>
        <b>My role</b>
        <p><strong>Design:</strong> While developing the website in collaboration with a three-person team, I coordinated the visual identity design.</p>
      ...
      paths: [
        {
          ...
          alt: 'Mobile mockup of the Data Machina website'
        },
        {
          img: 'datamachina/datamachina_website_onepage.jpg',
          alt: 'Data Machina company website'
        },
      ],
      thumb: {
        img: 'datamachina/thumb-datamachina_website_onepage.jpg',
        alt: 'Data Machina / Frontend project with HTML and CSS',
      },
      ano: 'December, 2021',
      github: 'https://github.com/MateusDuraessantos/site-datamachina-portf',
      description: `
        <b>Project portfolio</b>
        <p>In this project, with the design (for desktop) and content already developed beforehand by other collaborators, I was responsible for building the entire HTML and CSS structure and making it responsive for mobile devices.</p>
        <br>
    ...
    paths: [
      {
        ...
        alt: 'Wooden computer desk on a black background'
      },
      {
        img: 'mesa/1.jpg',
        alt: 'Desk corner detail'
      },
      {
        img: 'mesa/estrutura-mesa-de-pinus-gamer.jpg',
        alt: 'Desk leg structure'
      },
      {
        img: 'mesa/estrutura-mesa-de-madeira.jpg',
        alt: '3D model of the desk metal structure'
      },
      {
        img: 'mesa/mesa-gamer-preta.jpg',
        alt: 'Desk in black version'
      },
      {
        img: 'mesa/5.jpg',
        alt: 'Wooden computer desk on a white background'
      },
    ],
    thumb: {
      white: 'mesa/mesa-gamer',
      alt: 'Gaming/office desk',
    },
  ...
  },
  {
    ...
    paths: [
      {
        ...
        alt: 'Butterfly pendant in transparent and gold version'
      },
      {
        img: 'butterfly/butterfly-white.jpg',
        alt: 'Model wearing the necklace'
      },
      {
        img: 'butterfly/colar-vermelho-3d.jpg',
        alt: 'Pendant in red version'
      },
      {
      ...
      },
      {
        ...
        alt: '3D modeled butterfly necklace'
      },
    ],
    thumb: {
    ...
    description: `<a href="https://www.behance.net/gallery/143019519/Necklace-Butterfly" target="_blank">Behance</a>`,
  },
  {
    id: 'asdkljghsadfkg',
    name: 'Mun',
    alt: 'Wall lamp, 3D modeling in Cinema 4D',
    paths: [
      {
        img: 'mun/mun_arandela_escamoteavel.jpg',
        alt: 'Retractable wall lamp (closed)'
      },
      {
      ...
      },
      {
        ...
        alt: 'Retractable wall lamp (open)'
      },
      {
      ...
      {
        img: 'mun/mun_tag.jpg',
        alt: 'Product tag with the name Mun'
      },
      {
        img: 'mun/mun_Iluminacao.jpg',
        alt: 'Lighting variations of the lamp'
      },
      {
        img: 'mun/mun_area_de_iluminacao.jpg',
        alt: 'Moon phase lighting concept'
      },
    ],
    thumb: {
      white: 'mun/mun-arandela',
      alt: 'Retractable wall lamp'
    },
    description: `
      <b>Project portfolio</b>
      <p>Mun is a retractable wall lamp. The project was developed by me in collaboration with a three-person team. We drew inspiration from elements of Eastern culture and the phases of the moon. In this project, I was fully responsible for physical prototyping, 3D modeling, and rendering.</p>
      <br>
