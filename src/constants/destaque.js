  ...
  carrossel_01: [
    ...
    /* Tre */
    {
      ...
      description: `
        ...
        <br>
        <p>
          <strong>Design</strong>: All of Tre's branding was studied, and following the brief, I created a new UX/UI landing page interface. The project was built following design thinking methodologies and prototyped in Figma.
        </p>
        
        <p>
          <strong>Development</strong>: I developed the entire front-end structure, used GitHub to manage and version the code and finally hosted it on Tre's domain to go online.
        </p>
        <br>
        <b>Development kit</b>
        <br>
    ...
    /* Design System */
    {
      ...
      description: `
        ...
        <br>
        <p>
          I was responsible for the entire frontend development of the project. The website was built with Vue.js 2 and Element Plus, hosted through Firebase Console Hosting. My main goal was to customize and extend all Element Plus components to align them with Data Machina’s visual identity and design principles, ensuring a cohesive and branded user experience across all interfaces.
        </p>
        <br>
        <b>Development kit</b>
        <br>
